  ...
  return (
    <div className="p-8 h-screen bg-gray-900 flex flex-col items-center justify-center">
      ...
      <div className="grid grid-cols-7 gap-2 mb-8">
        {grid.map((row, rowIndex) =>
          row.map((cell, colIndex) => (
            <div
              className={`w-12 h-12 transition-colors transition-transform duration-500 transform ${
                cell === "red"
                  ? "bg-red-500"
                  : cell === "yellow"
                  ? "bg-yellow-500"
                  : "bg-gray-500"
              } ${activeCell === colIndex && "scale-75"}`}
      ...
      {winner && (
        <h2
          className={`text-4xl ${
            winner === "red" ? "text-red-500" : "text-yellow-500"
          }`}
        >
      ...
      <div className="footer">
        <div className="flex flex-col justify-start">
          <h4 className="text-xxl text-white">
            Created by <span className="text-blue-500">Abdullah Al Hilfi</span>
          </h4>
          <h4 className="text-xxl text-blue-500 text-center">
            <a
              className="
            
            "
              href="http://www.github.com/abjj1999"
              target="_blank"
